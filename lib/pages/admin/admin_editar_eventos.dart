      ...
      body: Padding(
        ...
        child: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot snapshot) {
              ...
              _vista_anteriror = evento['estado_evento'];
                    ...
                    Expanded(
                      child: ListView(
                        children: [
                          ...
                          Text('El estado anterior es: ' + _vista_anteriror),
                          Text('Al que lo quiere cambiar: '),
                          campoEstado_evento(),
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () async {
          ...
          if (_vista != '') {
            estado_evento = _vista;
          } else {
            estado_evento = _vista_anteriror;
          }
